...
Данный текст представляет из себя описание работы и функциональных особенностей программы "Шифры простой замены".
 
ВНИМАНИЕ: если возникнут проблемы при запуске кода приложения - данный репозиторий содержит RAR-архив полного проекта. При необходимости, можно скачать его и распаковать на компьютере для тестирования
